...
export const ISLAND_ZONES: IslandZone[] = [
  {
    ...
    position: { x: 20, y: 68 },
    slots: [
      { slotId: "harbor-1", position: { x: 12, y: 72 }, buildingKey: null },
      { slotId: "harbor-2", position: { x: 38, y: 62 }, buildingKey: null },
      { slotId: "harbor-3", position: { x: 62, y: 70 }, buildingKey: null },
    ],
  },
  {
    key: "market",
    ...
    position: { x: 52, y: 45 },
    slots: [
      { slotId: "market-1", position: { x: 22, y: 48 }, buildingKey: null },
      { slotId: "market-2", position: { x: 42, y: 38 }, buildingKey: null },
      { slotId: "market-3", position: { x: 68, y: 44 }, buildingKey: null },
      { slotId: "market-4", position: { x: 82, y: 52 }, buildingKey: null },
    ],
  },
  {
    key: "hill",
    ...
    position: { x: 46, y: 17 },
    slots: [
      { slotId: "hill-1", position: { x: 25, y: 22 }, buildingKey: null },
      { slotId: "hill-2", position: { x: 48, y: 12 }, buildingKey: null },
      { slotId: "hill-3", position: { x: 68, y: 20 }, buildingKey: null },
    ],
  },
];
